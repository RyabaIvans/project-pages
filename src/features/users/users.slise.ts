...
// const users = createAppAsyncThunk<void, any>('auth/setNewPass', async (arg, thunkAPI) => {
//     await usersApi.users()
// })
...
export const forTosterCall = (state: RootState) => state.users.successFlag
...
// export const isPasswordRequest = (state: RootState) => state.auth.passwordRequest;
